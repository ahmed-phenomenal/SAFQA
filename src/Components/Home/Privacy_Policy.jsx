    ...
    <div className="legal-page" dir={isArabic ? "rtl" : "ltr"}>
      <div className="legal-container">
        ...
        <div className="legal-card">
          <h2 dir="auto">{t("privacyS1Title") || "Information We Collect"}</h2>
          <p dir="auto">
            {t("privacyS1Desc") ||
        ...
        <div className="legal-card">
          <h2 dir="auto">{t("privacyS2Title") || "How We Use Your Information"}</h2>
          <p dir="auto">
            {t("privacyS2Desc") ||
        ...
        <div className="legal-card">
          <h2 dir="auto">{t("privacyS3Title") || "Sharing Information"}</h2>
          <p dir="auto">
            {t("privacyS3Desc") ||
        ...
        <div className="legal-card">
          <h2 dir="auto">{t("privacyS4Title") || "Data Security"}</h2>
          <p dir="auto">
            {t("privacyS4Desc") ||
